...
# ADRIFT 5 blorbs have the wrong length recorded in their top-level
# FORM chunk; this version corrects for that.  -- AW 2026
...
class BlorbFile:
    def __init__(self, filename, outfilename=None):
        ...
        self.formchunk.chunksize = os.path.getsize(filename) - 8
